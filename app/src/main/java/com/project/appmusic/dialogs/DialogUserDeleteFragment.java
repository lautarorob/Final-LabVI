...
public class DialogUserDeleteFragment extends DialogFragment {
    ...
    public DialogUserDeleteFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_dialog_user_delete, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        musicViewModel = new ViewModelProvider(requireActivity()).get(MusicViewModel.class); // <-- LÍNEA FALTANTE AGREGADA
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            android.widget.Toast.makeText(requireContext(), R.string.account_deleted, android.widget.Toast.LENGTH_SHORT).show();

            if (userViewModel != null) {
                userViewModel.deleteCurrentAccount();
            }
